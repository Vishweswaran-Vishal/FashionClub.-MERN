...
const productSlice = createSlice({
  ...
  initialState: {
    products: [],
    selectedProduct: null, // State to store the selected product details
    similarProducts: [],
    loading: false,
    error: null,
    filters: {
  ...
  reducers: {
    // Set filters for product search
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchProductDetails.fulfilled, (state, action) => {
        state.loading = false;
        state.selectedProduct = action.payload.product; // Update selectedProduct with fetched product details
      })
